...
- **VS Code integration** — tree view with status indicators, split view with n8n canvas, and a config screen for global instance management plus workspace overrides.
- **Multi-instance support** — keep multiple global n8n-manager instances and optionally pin the effective instance per workspace.
